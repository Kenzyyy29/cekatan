  ...
  <div>
   <section className="bg-gradient-to-br from-yellow-800 to-yellow-400 h-auto py-[13%] px-56">
    ...
    <p className="text-bone mt-4 2xl:mt-6 2xl:text-xl">
     Dengan <span className="font-bold">SELLARIS POS</span> Semua Menjadi Lebih
     Mudah
    </p>
   ...
   <section className="bg-bone h-auto py-20 px-56">
    <h1 className="text-black font-bold text-2xl 2xl:text-4xl text-end">
     Satu Aplikasi untuk Semua Jenis Usaha
    </h1>
    <div className="ml-[46%] 2xl:ml-[55%] mt-6 text-black gap-x-6 text-start xl:max-w-xl 2xl:max-w-2xl 2xl:text-xl">
     <p>
      Dengan aplikasi Sellaris POS, anda dapat menggunakan fitur untuk segala
      jenis usaha seperti :
     </p>
   ...
   {/* Fitur Untuk Semua Jenis Usaha */}
   <section className="bg-white h-auto py-14 px-56">
    <h1 className="text-black font-bold text-2xl 2xl:text-4xl text-center">
     Bagaimana cara berlangganan{" "}
     <span className="bg-gradient-to-br from-yellow-800 to-yellow-400 bg-clip-text text-transparent">
      Sellaris POS
     </span>
     ?
    </h1>
    <div className=" mt-6 text-black gap-x-6 text-start 2xl:max-w-2xl 2xl:text-xl">
     <h1>Proses Transaksi untuk Berlangganan di Sellaris POS sangat mudah.</h1>
     <div className="font-semibold text-xl my-3 max-w-xs">
      {/* Lakukan Registrasi */}
      <div className="text-start">
       <h1>Lakukan Registrasi</h1>
       <svg
        className="size-3 text-black my-2"
        viewBox="0 0 448 512"
        xmlns="http://www.w3.org/2000/svg">
        {/*} Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, */}
      ...
      <div className="text-start">
       <h1>Nikmati Fitur</h1>
        <Link href="">
         <button className="my-5 py-2 px-2 bg-gradient-to-br from-yellow-800 to-yellow-400 bg-clip-border rounded-full">
